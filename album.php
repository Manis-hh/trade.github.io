...
<html lang="en">
  ...
  <body>
    <h1 style="text-align:center; font-weight:bolder ; padding-bottom:10%"> OUR CLIENTS</h1>
    <div id="drag-container">
      <div id="spin-container">
        ...
        />
        <img
        src="./model/img/clients/KPMG.webp"  
        alt=""
        />
        <img
        src="./model/img/clients/Tata.webp"alt=""
        />
        <img
        src="./model/img/clients/Aditya_Birla.webp"alt=""
        />

        <!-- Example image with link -->
        <!-- <a
          target="_blank"
          href="./model/img/clients/KPMG.webp"
        >
          <img
            src="./model/img/clients/Tata.webp"
            alt=""
          />
        </a> -->

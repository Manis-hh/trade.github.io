                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                      ...
                                      <li><a href="domains.html">Analytical Report Data</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                      <li><a href="about.html">Asia Trade Data</a></li>
                                      <li><a href="blog.html">Africa Trade Data</a></li>
                                      <li><a href="domains.html">CIS Trade Data</a></li>
                                      <li><a href="ourservers.html">Europe Trade Data</a></li>
                                      <li><a href="mapdata.html">North America Trade Data</a></li>
                                      <li><a href="horizontalpricing.html">South America Trade Data</a></li>
                                    </ul>
                                </li>
...
<div class="container" >
    ...
    <div class="row">
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vero maxime exercitationem illum quaerat eum praesentium id quod, ea odio cupiditate sint? Optio temporibus expedita placeat earum amet. Assumenda eligendi minima aliquam laudantium repellendus ipsam facilis, non totam fugit sequi reiciendis veniam ullam necessitatibus id blanditiis dicta magnam ab vero sint, molestiae alias ipsa? Possimus, suscipit ab quos exercitationem rerum aliquid explicabo iusto! Eveniet numquam beatae reiciendis, suscipit debitis commodi nulla adipisci dicta fuga voluptatum obcaecati sed labore iste asperiores quo est? Iusto tenetur est repudiandae dolorem libero molestiae labore quisquam, dolores deleniti reprehenderit dolore sit. Nihil, doloribus! Excepturi, cumque quidem!</p>
    </div>
</div>
<div class="row" style="">
...
<div id="footer" class="container-fluid" >
  ...
  <div class="form-group col-md-6 col-sm-3" >
    ...
    <div class="form-group ">
      <label for="inputState">IMPORT/EXPORT</label>
  ...
  <button type="submit" class="btn btn-primary">SUBMIT</button>
          ...
          <ul class="social-menu">
            <li>
              <a href="#!" class="text-dark"><i class="fab fa-github"></i>
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
        © 2021 Copyright:
        <a class="text-reset fw-bold" href="https://tradeimex.com/">tradeimex.com</a>
    </div>
</footer> 
